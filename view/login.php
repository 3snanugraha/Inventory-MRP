                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="text" name="username" class="form-control rounded-5" id="yourUsername" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control rounded-5" id="yourPassword" required>
                      <div class="invalid-feedback">Silakan masukkan password Anda!</div>
                    </div>
                    <?php if (isset($_GET['error'])=='1'){
                      echo "<div class='badge bg-danger mt-2 rounded-5 text-center'>Username / Password salah. silahkan coba lagi</div>";
                    }
                    ?>
